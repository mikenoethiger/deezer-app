...
class TrackDetail(trackObject: JSONObject) {
    // Structure described at https://developers.deezer.com/api/track
    ...
    val unseen         = trackObject.getBoolean("unseen") // The track unseen status
    ...
    val album          = Album(trackObject.getJSONObject("album")) // album object containing : id, title, cover, cover_small, cover_medium, cover_big, cover_xl
}